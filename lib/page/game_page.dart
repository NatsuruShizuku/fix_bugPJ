...
//                               //     return Selector<GameManager, bool>(
//                               //       selector: (_, gm) =>
//                               //           gm.answeredWords.contains(index),
//                               //       builder: (_, isMatched, __) {
//                               //         return WordTile(
//                               //           key: ValueKey(_gridWords[index]
//                               //               .id), // ใช้ ID ที่ไม่เปลี่ยนแปลง
//                               //           index: index,
//                               //           word: _gridWords[index],
//                               //           isMatched: isMatched,
//                               //         );
...
//           end: Alignment.bottomRight,
//         ),
//         // สามารถใส่ภาพพื้นหลังแทน gradient ได้ เช่น
