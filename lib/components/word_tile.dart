...
//         builder: (_, notifier, __) {
//           final isCardOpen = 
//               notifier.tappedWords.containsKey(index) || isMatched;

//           return GestureDetector(
//             onTap: () {
//               if (!notifier.ignoreTaps && !isMatched) {
//                 notifier.tileTapped(index: index, word: word);
//               }
//             },
...
//                 decoration: BoxDecoration(
//                   borderRadius: BorderRadius.circular(8),
//                   color: isCardOpen ? Colors.transparent : Colors.deepPurple,
//                 ),
//                 child: isCardOpen
//                     ? _buildFrontContent()
//                     : _buildBackContent(),
...
//     return word.contents.isNotEmpty
//         ? Image.memory(
//             Uint8List.fromList(word.contents),
//             fit: BoxFit.cover,
//           )
...
//       builder: (_, notifier, __) {
//         final isOpen = notifier.tappedWords.containsKey(index) || isMatched;

//         return GestureDetector(
//           onTap: () => notifier.tileTapped(index: index, word: word),
//           child: MatchedAnimation(
//             numberOfWordsAnswered: notifier.answeredWords.length,
//             animate: isMatched,
//             child: Container(
...
//               decoration: BoxDecoration(
//                 borderRadius: BorderRadius.circular(8),
//                 color: isOpen ? Colors.white : Colors.deepPurple,
//                 border: Border.all(
...
//   Widget _buildFrontContent() {
//     return word.contents.isNotEmpty
//         ? Image.memory(Uint8List.fromList(word.contents), fit: BoxFit.cover)
//         : Center(child: Text(word.descrip, style: const TextStyle(fontSize: 16)));
//   }

//   Widget _buildBackContent() {
//     return const Icon(Icons.question_mark, size: 30, color: Colors.white);
//   }
// }